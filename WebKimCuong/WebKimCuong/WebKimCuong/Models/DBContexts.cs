...
namespace thuongmaidientus1.Models
{
    public class DBContexts : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("User Id=sa;Password=123;Server=QUANGSON;Database=shopkimcuongs;Trusted_Connection=True; TrustServerCertificate=true; Encrypt=false;")
